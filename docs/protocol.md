        # Meta Entropy: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/meta-entropy.git

        ## Objective

        MetaEntropy quantifies information-theoretic properties of meta-analytic datasets, measuring evidence diversity, redundancy, and synthesis informativeness.
        ...
        - Code: https://github.com/mahmood726-cyber/meta-entropy.git
